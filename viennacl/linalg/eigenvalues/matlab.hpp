...
//{
  ...
  //{
    ...
    writeTridiagSymMatlab(const char *filename,
                          const viennacl::vector<float> & d, const viennacl::vector<float> & s,
                          const std::vector<float> & eigenvals,
                          const unsigned int n)
    {
        ...
        writeVectorMatlab(file, "s", s, n);

        // write eigenvalues
        writeVectorMatlab(file, "eigenvalues", eigenvals, n);
