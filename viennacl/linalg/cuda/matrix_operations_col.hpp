  ...
  namespace linalg
  {
    namespace cuda
    {
                  ...
                  uint stride)
     {
      ...
      {
        vcl_size_t size_dh  = viennacl::traits::size(dh);
        vcl_size_t size_sh  = viennacl::traits::size(sh);
        viennacl::vector<NumericT> D(size_dh);
        viennacl::vector<NumericT> S(size_sh);
