...
int main()
{
	...
	//viennacl::vector<ScalarType> D(4);
	//viennacl::vector<ScalarType> S(4);
	//viennacl::vector<ScalarType> Q(12); // = ublas::scalar_vector<ScalarType>(sz, 0);
  ublas::vector<ScalarType> D = ublas::scalar_vector<ScalarType>(4, 0);
	ublas::vector<ScalarType> S = ublas::scalar_vector<ScalarType>(4, 0);
...
*/
  ...
  viennacl::linalg::bidiag_pack(A_input, D, S);
  vector_print(D);
  vector_print(S);
	//vector_print(D);
	//matrix_print(A_input);
